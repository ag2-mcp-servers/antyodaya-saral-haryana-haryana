...
class CertificateParameters(BaseModel):
    RefNo: str = Field(..., description='Reference No.', examples=['SRHR/2017/231234'])
    TokenNo: str = Field(
        ...,
        description='Token No.',
        examples=[
            '2912337nNn123 or date of issue in dd/mm/yyyy format if token number is less than 8 chars'
        ],
    )
...
class NbcerCertificatePostRequest(BaseModel):
...
class NbcerCertificatePostResponse(BaseModel):
...
class NbcerCertificatePostResponse1(BaseModel):
...
class NbcerCertificatePostResponse2(BaseModel):
...
class NbcerCertificatePostResponse3(BaseModel):
...
class NbcerCertificatePostResponse4(BaseModel):
...
class NbcerCertificatePostResponse5(BaseModel):
...
class NbcerCertificatePostResponse6(BaseModel):
